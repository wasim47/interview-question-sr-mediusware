<template>
    <section>
        ...
        <div class="col-sm-12" style="margin-bottom:10px">
            <div v-bind:style="{ backgroundColor: bgcolor, padding:10 +'px', color:'white'}">{{ responsemsg }}</div>
        </div>
        <div class="row">
            <div class="col-md-6">  
            ...
            if(product.title && product.sku){
                axios.post('/product', product).then(response => {
                    ...
                    if(response.data=='success'){
                        this.bgcolor = 'green';
                        this.responsemsg = 'Successfully Inserted. Page will refresh after 3 sec';
                        window.scrollTo(0,0);
